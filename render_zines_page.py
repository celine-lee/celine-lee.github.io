...
library_contents = [
    ...
    ("creatives/playlists.pdf", f"{thumbnail_folder}/playlists.jpg", "Playlists (on Nostalgia)"),
    ...
    ("creatives/please_be_seated.pdf", f"{thumbnail_folder}/please.jpg", "Please Be Seated"),
